...
export function WhatsNewIntroHeader({
  ...
  return (
    <div className="flex min-w-0 flex-col">
      <WhatsNewIntroArea>
        <WhatsNewHeroSection pageTitle={pageTitle} />
      ...
      <AnimatedSection variant="fade-up" staggerChildren>
        <UpdatesFeedSection updates={updates} activeCategory={activeCategory} />
      </AnimatedSection>
    </div>
  );
}
