...
import type { OurTeamPageContent } from "@/lib/types/our-team-page-content";

type OurTeamPageProps = {
  content: OurTeamPageContent;
};

export function OurTeamPage({ content }: OurTeamPageProps) {
  return (
        ...
        <AnimatedSection variant="fade-up" staggerChildren>
          <section className="mx-auto w-full max-w-7xl px-5 sm:px-6 md:px-10 lg:px-14 xl:px-20 2xl:px-28">
            <TeamGrid
              ...
              viewProfileLabel={content.viewProfileLabel}
              workshopsHeading={content.workshopsHeading}
            />
          </section>
        </AnimatedSection>
